...
export default function PlacesToStay({ hotels, language }: PlacesToStayProps) {
  ...
  return (
    <section className="mb-8 sm:mb-10 lg:mb-12" id="places-to-stay">
      {/* Outer wrap covering the entire section */}
      <div className="rounded-2xl overflow-hidden bg-gradient-to-br from-[#FDF6ED] via-[#F5E6D8] to-[#FFF8E7] border border-amber-200/50 shadow-xl shadow-amber-900/5 p-4 sm:p-6 lg:p-8">
        ...
        {/* Desktop: featured hotel (left) + Quick View sidebar (right) */}
        {filteredHotels.length > 0 ? (
                  ...
                  <header className="flex items-center justify-between gap-3 mb-4">
                    <div>
                      ...
                      <h3 className="text-base sm:text-lg font-bold text-premium-section-text mt-0.5">
                        {language === 'hi' ? 'अन्य होटल' : 'More stays'}
                      </h3>
                    </div>
                      ...
                      return (
                        ...
                        >
                          <div className="min-w-0 flex-1 flex flex-col items-start gap-0.5">
                            <span className="font-semibold text-sm sm:text-base text-primary-dark leading-snug break-words text-left">{hotel.name}</span>
